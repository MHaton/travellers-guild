          ...
          ...(!isLink ?
            {
              ...
              "pl-5 pr-5 py-4": _size === "lg",
            } : {}
          ),
          "shadow-md hover:shadow-lg": _variant === "shadow",
          "bg-neutral-500 text-neutral-200 cursor-not-allowed": disabled,
          "hover:shadow-lg": _size !== "sm" && _size !== "smb" && isPlain,
          "border-0 border-b-0": variant !== "secondary",
          // Plain colors
          "bg-neutral-900 hover:bg-neutral-700 text-white": _type === "default" && isPlain,
